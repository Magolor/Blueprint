...
The Python pre-commit hook runs `bash scripts/check.bash fast`. It checks the current repository contracts without generating files or staging unrelated changes.
