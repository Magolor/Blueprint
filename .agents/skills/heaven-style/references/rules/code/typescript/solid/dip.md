---
name: typescript-solid-dip
description: Read when applying dependency inversion to TypeScript object and dependency boundaries.
---
...
```ts
class Workspace {
  private readonly backend = new PostgresStore()
}
```
