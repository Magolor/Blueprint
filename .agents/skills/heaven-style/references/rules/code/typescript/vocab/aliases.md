---
name: typescript-vocab-aliases
description: Read before adding TypeScript API or CLI aliases.
---
...
| `fromDict`, `toDict` | `fromRecord`, `toRecord` | Existing mapping-conversion spellings, only with identical representation/validation contracts. |
