...
Also apply [architecture.md](architecture.md) for lifecycle ownership and registries, [types.md](types.md) for `unknown`/result contracts, [modules.md](modules.md) for optional imports, [docs.md](docs.md) for errors/disposal documentation, and [environment.md](environment.md) for typed lint and test gates.
