...
- When environment problems block progress, report the exact command, resolved runtime, and point of failure.
...
Apply [format](format.md), [tests](test.md), [TypeScript environment](../code/typescript/env.md), and [environment failure recovery](../../failures/env.md) as needed.
