...
3. Keep stable policy here, OS-wide operation playbooks in `assets/`, and single-machine facts in `assets/instance/`. For macOS setup maintenance, read [../../assets/MacOS-env.md](../../assets/MacOS-env.md). For Magolor's M5 Mac facts, read [../../assets/instance/Magolor-M5.md](../../assets/instance/Magolor-M5.md).
...
3. Put commands that apply across one OS family in `assets/`; put commands that name one host, account, or private path in `assets/instance/`. Keep this task limited to durable decision rules.
