---
name: workflow-design-plan
description: Read before writing a refactor or execution plan.
---
...
For an idea or architectural exploration, use the [design template](../../../assets/templates/design.md). Keep motivation, intuition, and architecture there. The [execution template](../../../assets/templates/plan.md) turns an accepted direction into implementation.

Before a major implementation assignment, write or update one brief
...
them in every child. Use [file-based handoff](../coordinate/handoff.md) for assignments.
...
Hand implementation slices to [code](../code/README.md) and rule-heavy execution to [developer](../code/slices.md).
