---
id: workflow-design-inspect
title: Architecture discovery
description: Read for architecture discovery.
---
...
5. Read linked Linear milestones, issue evidence, blockers, status comments, and design threads; read linked GitHub PRs, failing checks, reviews, and recent merges. Trackers remain subordinate to the declared queue. Use the [failure routes](../start.md) only when blocked.
