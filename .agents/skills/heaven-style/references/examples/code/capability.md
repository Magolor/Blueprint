...
The main warning sign is that adding one optional feature forces unrelated central edits.
...
Prefer the good-smell structure only when independent extensions own new identifiers. Keep closed domains closed.
