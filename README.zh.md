---
name: blueprint
description: 使用 TypeScript Blueprint 模板创建项目时阅读。
---
...
Blueprint 是严格的 TypeScript 项目模板，提供一个 SDK、轻量 CLI 和 Heaven Style 智能体指南。本分支包含当前的 `0.2.0-alpha.1` 模板。
...
请使用 Node.js 24 或更新版本，以及 `package.json` 声明的 pnpm 版本。
